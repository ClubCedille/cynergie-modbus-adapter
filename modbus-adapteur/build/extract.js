...
const startDate = DateHelper_1.parseISOLocal(start + 'T00:00:00');
const endDate = DateHelper_1.parseISOLocal(end + 'T00:00:00');
const MAX_PRECISION = 4;
const storage = new Storage_1.Storage(false);
const extractor = new RowExtractor_1.RowExtractor('./reports/custom/');
extractor.setReader((callback, endCb) => storage.readInterval(startDate, endDate, false, callback, endCb));
